...
class TodoProvider with ChangeNotifier{
  ...
  Future<void> setTodo({required String todo}) async {
    //
    // this._todos.add(
    //     TodoModel(
    //       id: _todos.length,
    ...
    this.notifyListeners();
    await Future.delayed(Duration(seconds:3));
    this._todos.add( await this._todoService.setTodo(todo));
    this._process = Process.OK;
    this.notifyListeners();
  }
}
